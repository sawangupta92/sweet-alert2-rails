...
(function($) {
  ...
  $(document).on('dynatable:init dynatable:afterUpdate turbolinks:load page:update ajaxComplete ajax:success ajaxSuccess ajax:error ajaxError', function () {
    $('[data-sweet-alert-confirm]').on('click', sweetAlertConfirm)
  });

  $(document).on('dynatable:init dynatable:afterUpdate turbolinks:load page:load', function () {
